            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light container">
                ...
                <div class="collapse navbar-collapse w-100 order-3" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @endif
                        <!-- &nbsp;&nbsp;&nbsp; -->
                        <li class="nav-item  border-md-right ml-3">
                    ...
                    <div class="form-inline">
                        <a class="btn btn-primary" href="{{ route ('subscribe.index') }}" style="font-size:1.5rem;width:103.367px; height:36px;float: right;background-color: #05B18B; border: none;" >Subscribe</a>
                    </div>
